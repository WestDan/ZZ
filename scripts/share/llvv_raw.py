...
if __name__ == "__main__":
    ...
    TITLES = {"l_e":["E [GeV]","events / 10GeV "],
              ...
              "delta_R_zz":["#{Delta}R_{zz}", "events/ 0.5"],
              "delta_R_jj":["#{Delta}R_{jj}", "events/ 0.5"],
              "delta_R_zz_jj":["#{Delta}R_{zzjj}", "events/ 0.5"],
              "delta_R_ll_1-delta_R_ll_2":["#{Delta}R_{ll}", "events/ 0.5"],
